...
const AI_DATA = {
  ...
  hero: {
    ...
    primary: { label: 'Launch the demo', href: './apps/unityDemo/unity.html', icon: 'arrow' },
    secondary: { label: 'See all our apps', href: './apps.html' },
  },
  ...
  cta: {
    ...
    primary: { label: 'Launch the demo', href: './apps/unityDemo/unity.html' },
    secondary: { label: 'Inquire about a build', href: './contact.html' },
  },
};
