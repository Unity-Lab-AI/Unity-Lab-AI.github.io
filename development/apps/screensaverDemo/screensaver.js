...
async function fetchImageModels() {
    try {
        // Use PolliLibJS constants with direct fetch (like demo page)
...
async function fetchDynamicPrompt() {
    ...
    try {
        // Use PolliLibJS constants with direct fetch (like demo page)
        const response = await fetch(`${PollinationsAPI.TEXT_API}/openai?referrer=${encodeURIComponent(polliAPI.referrer)}`, {
            method: "POST",
